...
class ScreenDetection {
    ...
    func adjacent(toFrameOfScreen frameOfScreen: CGRect, screens: [NSScreen]) -> AdjacentScreens? {
        if screens.count == 2 {
            ...
            // Spacing between operators +/-) and numbers is important !!
    ...
    func order(screens: [NSScreen]) -> [NSScreen] {
        ...
        // Also SortedByX feeds some data into sortedByY
    ...
    private func computeAreaOfRect(rect:CGRect) -> CGFloat { return rect.size.width * rect.size.height}
}
