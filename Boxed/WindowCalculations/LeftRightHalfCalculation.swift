...
class LeftRightHalfCalculation: WindowCalculation, RepeatedExecutionsCalculation {
    ...
    func calculateLeftAcrossDisplays(_ window: Window, lastAction: BoxedAction?, screen: NSScreen, usableScreens: UsableScreens) -> WindowCalculationResult? {
    ...
    func calculateRightAcrossDisplays(_ window: Window, lastAction: BoxedAction?, screen: NSScreen, usableScreens: UsableScreens) -> WindowCalculationResult? {
